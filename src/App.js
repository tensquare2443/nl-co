...
class App extends Component {
  ...
  notGoing = (e) => {
    ...
    this.setState({user});
    axios.post(
      `http://localhost:3001/attend/remove`,
      data,
  ...
  viewProfile = () => {
    ...
    axios.get(`http://localhost:3001/user/view?${params}`, {
      headers: {
  ...
  rsvp = (exName, exDate) => {
    ...
    axios.post('http://localhost:3001/attend/add', {userId, attending}, {
      headers: {
  ...
  createAccountSubmit = (e) => {
    ...
    axios.post('http://localhost:3001/user/submit', {username, password}).then((response) => {
  ...
  searchFormSubmit = (e, offset) => {
    ...
    axios.get(`http://localhost:3001/search?${params}`).then((response) => {
      ...
      var searchResults = response.data.map((result) => {
        ...
        axios.post('http://localhost:3001/attend/view', {business: result.id}).then((response) => {
